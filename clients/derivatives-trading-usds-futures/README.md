# Binance Java Derivatives Trading USDS Futures Connector
...
[![Maven Central Version](https://img.shields.io/maven-central/v/io.github.binance/binance-derivatives-trading-usds-futures)](https://central.sonatype.com/artifact/io.github.binance/binance-derivatives-trading-usds-futures)
...
- [REST API](./src/main/java/com/binance/connector/client/derivatives_trading_usds_futures/rest/api)
- [Websocket API](./src/main/java/com/binance/connector/client/derivatives_trading_usds_futures/websocket/api)
- [Websocket Stream](./src/main/java/com/binance/connector/client/derivatives_trading_usds_futures/websocket/stream)
...
For detailed information, refer to the [Binance API Documentation](https://developers.binance.com/docs/derivatives/usds-margined-futures/).

### REST APIs

All REST API endpoints are available through the [`rest`](./src/main/java/com/binance/connector/client/derivatives_trading_usds_futures/rest) module. Note that some endpoints require authentication using your Binance API credentials.
...
More examples can be found in the [`examples/rest`](./../../examples/derivatives-trading-usds-futures/src/main/java/com/binance/connector/client/derivatives_trading_usds_futures/rest) folder.
...
```bash
mvn -f clients/pom.xml -pl derivatives-trading-usds-futures test
```
